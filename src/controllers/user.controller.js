...
exports.createUser = catchAsync(async (req, res, next) => {
    const { firstName, secondName, firstLastName, secondLastName, email, password, admin } = req.body
    ...
    if (emailExists) {
        return next(new AppError('Ya existe el email registrado, prueba con otro'), 404);
    }
...
exports.changePassword = catchAsync(async (req, res, next) => {
    ...
    if (oldPassword === newPassword) {
        return next(new AppError('La nueva contraseña debe ser diferente a la actual.'), 404)
    }
