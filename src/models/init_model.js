...
const initModel = () => {
    ...
    Users.hasMany(Vehicles, { foreignKey: 'user_id', onDelete: 'CASCADE', onUpdate: 'CASCADE' });
    Vehicles.belongsTo(Users, { foreignKey: 'user_id' });

    // Relation Vehicles -> Positions
    Vehicles.hasMany(Positions, { foreignKey: 'vehicle_id', onDelete: 'CASCADE', onUpdate: 'CASCADE' });
